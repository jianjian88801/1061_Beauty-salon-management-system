...
public class JishiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		JishiEntity user = jishiService.selectOne(new EntityWrapper<JishiEntity>().eq("jishigonghao", username));
    ...
    public R register(@RequestBody JishiEntity jishi){
    	...
    	JishiEntity user = jishiService.selectOne(new EntityWrapper<JishiEntity>().eq("jishigonghao", jishi.getJishigonghao()));
		if(user!=null) {
