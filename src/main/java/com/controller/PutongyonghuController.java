...
public class PutongyonghuController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		PutongyonghuEntity user = putongyonghuService.selectOne(new EntityWrapper<PutongyonghuEntity>().eq("zhanghao", username));
    ...
    public R register(@RequestBody PutongyonghuEntity putongyonghu){
    	...
    	PutongyonghuEntity user = putongyonghuService.selectOne(new EntityWrapper<PutongyonghuEntity>().eq("zhanghao", putongyonghu.getZhanghao()));
		if(user!=null) {
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,PutongyonghuEntity putongyonghu, 
		HttpServletRequest request){
        EntityWrapper<PutongyonghuEntity> ew = new EntityWrapper<PutongyonghuEntity>();
		PageUtils page = putongyonghuService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, putongyonghu), params), params));
        return R.ok().put("data", page);
